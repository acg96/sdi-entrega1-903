...
public class PO_PrivateView extends PO_NavView {
	...
	public static void checkChangeIdiomHome(WebDriver driver) {
		...
		SeleniumUtils.EsperaCargaPagina(driver, "text", p.getString("home.description", PO_Properties.SPANISH),
				getTimeout());
		...
		SeleniumUtils.EsperaCargaPagina(driver, "text", p.getString("home.description", PO_Properties.ENGLISH),
				getTimeout());
